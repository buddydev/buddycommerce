<?php
/**
 * BuddyCommerce Autoload Implementation.
 *
...
/**
 * Auto Loader for BuddyCommerce.
 *
 * After registering this autoload function with SPL, the following line
 * would cause the function to attempt to load the \BuddyCommerce\Bar\Baz\Qux class
 * from /path/to/wp-content/plugins/buddycommerce/src/bar/baz/class-qux.php:
 *
 *      new \BuddyCommerce\Baz_Xyz\Qux;
 *  maps to /path/to/wp-content/plugins/buddycommerce/src/bar/baz-xyz/class-qux.php
 * The path/directory name should be all lowercase and the the class file is named as 'class-$classname.php'
 */
class BC_Autoloader {

	/**
	 * Namespace root. eg. BuddyCommerce\\(escaped slashes);
	 *
	 * @var string
	 */
